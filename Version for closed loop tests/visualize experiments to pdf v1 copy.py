...
def generate_pdf_report(data, experiments_df, output_pdf):
    ...
    with PdfPages(output_pdf) as pdf:
        for index, experiment in experiments_df.iterrows():
            ...
            for col in ['CO2', 'ALI_FLOW', 'ALI_PRESSURE']:
                ...
                # Plot scatter plot for the current column
                plt.figure(figsize=(10, 6))
                plt.scatter(exp_data['temp_time'], exp_data[col], label=col, color='blue', s=10)
                ...
                plt.scatter(first_5_min_data['temp_time'], first_5_min_data[col], color='lightgrey', s=10)

                if len(post_5_min_data) > 1:
                    # Plot the trend line
                    plt.plot(post_5_min_data['temp_time'], trend_line, color='red', label=f'Trend line (slope={m:.5f})')
...
if __name__ == "__main__":
    ...
    output_pdf = "/Users/jwozniak/Library/CloudStorage/OneDrive-Picarro,Inc/PROJECTS/CLOSED LOOP TESTS/experiment_report2.pdf"
